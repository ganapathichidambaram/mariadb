...
columnstoreSyslogFile=/usr/share/columnstore/columnstoreSyslog
columnstoreSyslogFile7=/usr/share/columnstore/columnstoreSyslog7
...
if [ "$daemon" = "syslog-ng" ]; then
	if [ -f /etc/syslog-ng/syslog-ng.conf ]; then
		...
		columnstoreSyslogFile=/usr/share/columnstore/columnstoreSyslog-ng
		echo ""
...
if [ ! -z "$syslog_conf" ] ; then
	...
	if [ -d /etc/logrotate.d ]; then
		cp /usr/share/columnstore/columnstoreLogRotate /etc/logrotate.d/columnstore > /dev/null 2>&1
